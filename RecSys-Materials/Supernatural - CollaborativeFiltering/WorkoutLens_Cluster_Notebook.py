    ...
    *
    from (
        ...
        where ws.CREATED_AT >= '2020-04-23'
            ...
            and ws.user_id NOT IN ('Ua61ZFw', 'Uq6knIA', 'UkgX8SQ')
    ...
    *
    from (
        ...
        where ws.CREATED_AT >= '2020-04-23'
            ...
            and w.ID NOT IN (1407, 1405, 1361, 1319, 965)
            and ws.CREATED_AT > w.LAUNCH_DATE
            and ws.user_id IN ('Ua61ZFw', 'Uq6knIA', 'UkgX8SQ')
    ...
    *
    FROM (
        ...
        WHERE 1=1
            ...
            AND w.WORKOUT_TYPE in ('classic', 'boxing')
            AND w.ID NOT IN (1407, 1405, 1361, 1319, 965)
            AND AUTHOR_ID NOT IN ('Ua61ZFw', 'Uq6knIA', 'UkgX8SQ')
        LIMIT 80000
    ) a
    ...
    *
    FROM (
        ...
        WHERE 1=1
            ...
            AND w.WORKOUT_TYPE in ('classic', 'boxing')
            AND w.ID NOT IN (1407, 1405, 1361, 1319, 965)
            AND AUTHOR_ID IN ('Ua61ZFw', 'Uq6knIA', 'UkgX8SQ')
        ORDER BY 1
        LIMIT 80000
    ) b
'''
